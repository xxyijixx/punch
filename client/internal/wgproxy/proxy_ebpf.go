...
import (
	...
	"yiji.one/punch/client/internal/ebpf"
	ebpfMgr "yiji.one/punch/client/internal/ebpf/manager"
	nbnet "yiji.one/punch/util/net"
)
...
func NewWGEBPFProxy(ctx context.Context, wgPort int) *WGEBPFProxy {
	...
	log.Info("Instantiate ebpf proxy")
	wgProxy := &WGEBPFProxy{
